...
Once the `conda-forge` channel has been enabled, `iprpy` can be installed with:

```
conda install iprpy
```

It is possible to list all of the versions of `iprpy` available on your platform with:
